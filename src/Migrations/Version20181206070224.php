 ...
 */
final class Version20181206070224 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product ADD product_type_id INT DEFAULT NULL, DROP type');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product ADD type INT NOT NULL, DROP product_type_id');
    }
}
